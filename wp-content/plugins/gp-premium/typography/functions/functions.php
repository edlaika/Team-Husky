...
function generate_fonts_customize_register( $wp_customize ) {
	...
	if ( isset( $defaults[ 'font_top_bar' ] ) && function_exists( 'generate_is_top_bar_active' ) ) {
		...
		$wp_customize->add_control( 
			new Generate_Google_Font_Dropdown_Custom_Control( 
				...
				'generate_settings[font_top_bar]', 
				array(
					'label' => __( 'Top bar','generate-typography' ),
					'section' => 'generate_top_bar_typography',
					'settings' => 'generate_settings[font_top_bar]',
					'priority' => 50,
		...
		$wp_customize->add_control( 
			new Generate_Hidden_Input_Control( 
				...
				array(
					'section' => 'generate_top_bar_typography',
					'settings' => 'font_top_bar_category',
					'type' => 'gp-hidden-input',
					'priority' => 50,
					'active_callback' => 'generate_is_top_bar_active'
				)
		...
		$wp_customize->add_control( 
			new Generate_Hidden_Input_Control( 
				...
				array(
					'section' => 'generate_top_bar_typography',
					'settings' => 'font_top_bar_variants',
					'type' => 'gp-hidden-input',
					'priority' => 50,
					'active_callback' => 'generate_is_top_bar_active'
				)
	...
	if ( isset( $defaults[ 'top_bar_font_weight' ] ) && function_exists( 'generate_is_top_bar_active' ) ) {
		// Font weight
		$wp_customize->add_setting( 
		...
		$wp_customize->add_control( 
			new Generate_Select_Control( 
				...
				array(
					'label' => __('Font weight','generate-typography'),
					'section' => 'generate_top_bar_typography',
					'settings' => 'generate_settings[top_bar_font_weight]',
					'priority' => 60,
					'type' => 'gp-typography-select',
					'choices' => array(
						'normal' => 'normal',
	...
	if ( isset( $defaults[ 'top_bar_font_transform' ] ) && function_exists( 'generate_is_top_bar_active' ) ) {
		// Text transform
		$wp_customize->add_setting( 
		...
		$wp_customize->add_control( 
			new Generate_Select_Control( 
				...
				array(
					'label' => __('Text transform','generate-typography'),
					'section' => 'generate_top_bar_typography',
					'settings' => 'generate_settings[top_bar_font_transform]',
					'priority' => 70,
					'type' => 'gp-typography-select',
					'choices' => array(
						'none' => 'none',
		...
		$wp_customize->add_control( 
			new Generate_Customize_Slider_Control( 
				...
				array(
					'label' => __('Font size','generate-typography'),
					'section' => 'generate_top_bar_typography',
					'settings' => 'generate_settings[top_bar_font_size]',
					'priority' => 75,
					'type' => 'gp-typography-slider',
					'default_value' => $defaults['top_bar_font_size'],
					'unit' => 'px',
					'active_callback' => 'generate_is_top_bar_active'
				)
			)
